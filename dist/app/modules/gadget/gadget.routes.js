...
exports.GadgetRoutes = void 0;
const express_1 = __importDefault(require("express"));
const validateRequest_1 = __importDefault(require("../../middlewares/validateRequest"));
const gadget_controller_1 = require("./gadget.controller");
const gadget_validation_1 = require("./gadget.validation");
 ...
 */
router.post('/create-gadget', (0, validateRequest_1.default)(gadget_validation_1.GadgetValidation.createGadgetZodSchema), gadget_controller_1.GadgetController.createGadget);
/**
 * @swagger
 * /gadgets/{id}:
 *   patch:
 ...
 *               message: "Something went wrong"
 */
router.patch('/:id', (0, validateRequest_1.default)(gadget_validation_1.GadgetValidation.updateGadgetZodSchema), gadget_controller_1.GadgetController.updateGadgetDetails);
/**
 * @swagger
 * /gadgets:
 *   get:
 ...
 *               message: "Something went wrong"
 */
router.get('/:id', gadget_controller_1.GadgetController.getGadgetDetails);
/**
 * @swagger
 * /gadgets/{id}:
 *   get:
 ...
 *               message: "Something went wrong"
 */
router.get('/', gadget_controller_1.GadgetController.getGadgetsList);
/**
 * @swagger
 * /gadgets/bulk-delete:
 *   delete:
 ...
 *               message: "Something went wrong"
 */
router.delete('/bulk-delete', gadget_controller_1.GadgetController.bulkDeleteGadgets);
/**
 * @swagger
 * /gadgets/{id}:
 *   delete:
 ...
 *               error: "Not Found"
 */
router.delete('/:id', gadget_controller_1.GadgetController.deleteGadget);
exports.GadgetRoutes = router;
